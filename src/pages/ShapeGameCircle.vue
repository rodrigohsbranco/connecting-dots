...
<template>
  <div class="circle" :style="{ backgroundImage: `url(${circleBg})` }">
    ...
    <section class="veryGood">
      ...
      <div class="veryGood__text">
        ...
        <img @click="nextShape('/ShapeGameTrapeze')" :src="nextButton" alt="Botão de seta para o próximo desafio de forma!">
      </div>
    </section>
  </div>
</template>

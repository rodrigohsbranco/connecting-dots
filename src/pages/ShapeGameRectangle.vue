...
import numberRec from "../assets/images/numbers/7-rectangle.png";
...
onMounted(() => {
  ...
  function resizeCanvas() {
    ...
    if (window.innerWidth <= maxWidth && window.innerWidth > widthMin) {
      ...
      canvasParticles.height = 320;
      
      canvasStars.width = 480;
      canvasStars.height = 320;
    } 
      ...
      canvasParticles.width = 380;
      canvasParticles.height = 250;
      
      canvasStars.width = 410;
      ...
      canvasParticles.width = 630;
      canvasParticles.height = 500;
      
      canvasStars.width = 660;
...
<template>
  <div class="rectangle">
    ...
    <img :src="numberRec" class='numbers' alt="numbers">
    ...
    <section class="veryGood">
      ...
      <div class="veryGood__text">
        ...
        <img
          @click="nextShape('/ShapeGameHexagon')"
          :src="nextButton"
...
@keyframes butterfly-flap {
  0%, 100% {
    transform: translate(0px, 0px) rotateX(0) rotateY(0) rotate(30deg);
  }

  50% {
    transform: translate(5px, 14px) rotateX(3deg) rotateY(3deg) rotate(30deg);
  }
}
